...
public class FormFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNombre = (EditText) view.findViewById(R.id.element_name);
        mValor = (EditText) view.findViewById(R.id.element_value);
        creater = (Button) view.findViewById(R.id.create_element);
        outer = (Button) view.findViewById(R.id.out);
        ...
        creater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Items newItem = new Items(nombre,valor);
                mDatabase.push().setValue(newItem).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
